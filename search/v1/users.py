...
class userlisting(Resource):
    def get(self):
        try:
            ...
            parser.add_argument('page', type=int, help='page of listing',
                                default=1, required=False, location='args')
            parser.add_argument('count', type=int, help='total number of listings',
                                default=20, required=False, location='args')
